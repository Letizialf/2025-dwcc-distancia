document
  .getElementById("executarReplace")
  .addEventListener("click", function () {
    ...
    let resultado1 = null;
    //TODO: O alumnado debe editar es liña
    resultado1 = texto.replace(/exemplo/, "substituido");
    console.log(resultado1);

    // 2. Substituír todas as ocorrencias da palabra "exemplo" usando o flag
    ("g");
    console.log("Substituír todas as ocorrencias de 'exemplo' (flag 'g'):");
    let resultado2 = null;
    //TODO: O alumnado debe editar es liña
    resultado2 = texto.replace(/exemplo/g, "substituido");
    ...
    let resultado3 = null;
    //TODO: O alumnado debe editar es liña
    resultado3 = texto.replace(/exemplo/i, "substituido");
    console.log(resultado3);

    // 4. Substituír todas as ocorrencias de "exemplo" ignorando maiúsculas/minúsculas (flags 'gi')
    console.log(
      "Substituír todas as ocorrencias de 'EXEMPLO' ou 'exemplo' (flags 'gi'):"
    );
    let resultado4 = null;
    //TODO: O alumnado debe editar es liña
    resultado4 = texto.replace(/exemplo/gi, "substituido");
    ...
    let resultado5 = null;
    //TODO: O alumnado debe editar es liña
    resultado5 = texto.replace(/^exemplo/gm, "inicio_substituido");
